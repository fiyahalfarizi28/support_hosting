...
<div class="modal-body">
    <form id="frm-rating" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            </div>	    <?php if ($rows->risk_type != NULL ) { ?>                <div class="col-md-12">                    <label style="margin-top: 8px">MEMPENGARUHI FINANCIAL :</label>                    <select id="risk_type"name="risk_type" class="form-control" required disabled>                        <option value="<?php echo $rows->risk_type ?>" selected="selected"><?php echo $rows->risk_type ?></option>                    </select>                </div>            <?php } ?>
        </div>
