            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-home"></i> HOME</a></li>

                            <ul class="collapse list-unstyled" id="homeSubmenu">

                                <li style ="margin-left: 25px; margin-top: 8px"class="list-group-item">

                                    <a href="<?php echo base_url('dashboard') ?>"><i class="fa fa-chart-line"></i> DASHBOARD</a>

                                </li>

                                <li style ="margin-left: 25px;"class="list-group-item">

                                    <a href="<?php echo base_url('chart') ?>"><i class="fa fa-chart-pie"></i> CHART</a>

                                </li>

                                <li style ="margin-left: 25px; margin-bottom: 8px" class="list-group-item">

                                    <a href="<?php echo base_url('activity') ?>"><i class="fa fa-tasks"></i> ACTIVITY</a>
                        ...
                        <?php if ( $SESSION_USER_JABATAN != 'IT STAFF') { ?>
                            ...
                            <li class="list-group-item"><a href="#rfmSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="far fa-folder-open"></i> RFM</a></li>

                                <ul class="collapse list-unstyled" id="rfmSubmenu">

                                    <li style ="margin-left: 25px; margin-top: 8px"class="list-group-item">

                                        <a href="<?php echo base_url('rfm') ?>"><i class="far fa-edit"></i> INPUT RFM</a>
                                    ...
                                    <li style ="margin-left: 25px; margin-bottom: 8px" class="list-group-item">
                                        ...
                                        <a href="<?php echo base_url('history_rfm') ?>"><i class="fa fa-history"></i> HISTORY RFM</a>

                                    </li>

                                </ul>

                            <li class="list-group-item"><a href="#rfpSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="far fa-folder-open"></i> RFP</a></li>

                                <ul class="collapse list-unstyled" id="rfpSubmenu">

                                    <li style ="margin-left: 25px; margin-top: 8px"class="list-group-item">

                                        <a href="<?php echo base_url('rfp') ?>"><i class="far fa-edit"></i> INPUT RFP</a>
                                    ...
                                    <li style ="margin-left: 25px; margin-bottom: 8px" class="list-group-item">
                                        ...
                                        <a href="<?php echo base_url('history_rfp') ?>"><i class="fa fa-history"></i> HISTORY RFP</a>
                        ...
                        <?php
                            ...
                            if($this->session->userdata('USER_DIVISI') === 'IT') {
                                ...
                                echo "<li class='list-group-item'><a href='".base_url('daily_report')."'><i class='far fa-calendar-alt'></i> DAILY ACTIVITY</a></li>";
