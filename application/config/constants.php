...
define('JABATAN_HEAD_TANPA_IT', ["AREA MANAGER", "DIREKTUR", "DEPARTMENT HEAD", "DEPARTMENT HEAD HC", "KEPALA KANTOR KAS", "PIMPINAN CABANG", "UNIT HEAD OPERATIONAL &AMP; SUPPORT", "UNIT HEAD OPERASIONAL MICRO FINANCING", "UNIT HEAD OPERASIONAL DEVELOPMENT", "COMPENSATION AND BENEFIT HEAD", "COMPENSATION AND BENEFIT SPECIALIST", "HC LEARNING &AMP; DEVELOPMENT SECURE FINANCING SPC", "HC PERSONALIA", "HC RECRUITMENT", "HC RECRUITMENT SPECIALIST", "HC TRAINING", "HEAD HUMAN CAPITAL", "HUMAN CAPITAL AREA HEAD", "HUMAN CAPITAL BUSINESS PARTNER HEAD", "SUPERVISOR HUMAN CAPITAL AREA", "ADMIN HEAD OFFICE", "BRANCH DEVELOPMENT AND MONITORING DEPARTEMEN HEAD", "COMPENSATION AND BENEFIT HEAD", "CREDIT ANALYST HEAD", "DEPARTMENT HEAD", "DEPARTMENT HEAD HC", "DEPARTMENT HEAD SECURE FINANCING", "DISTRICT MICRO HEAD", "FUNDING HEAD", "HEAD ACCOUNTING", "Head Cabang", "HEAD COLLECTOR", "HEAD DEPT BISNIS", "HEAD FINANCE", "HEAD HUMAN CAPITAL",  "HEAD KOLEKTOR", "HEAD LEGAL", "HEAD MARKETING", "HEAD MARKETING KARAWANG", "Head Op", "HEAD OPERASIONAL", "HEAD OPERASIONAL BEKASI BSD", "HEAD OPERASIONAL BSD", "HEAD OPERASIONAL CITEUREUP", "HEAD OPERASIONAL KARAWANG", "HEAD OPERATIONAL", "HEAD OPS", "HEAD OPS CITEUREUP", "HEAD OPS SINBAR PJS", "HEAD SKAI DAN FA", "HEADKASCIKARANG_PJS", "HEADOPSBEKUT_PJS", "HEADOPSBSD_PJS", "HEADOPSKARAWANG_CADANGAN", "HEADOPS_CIKARANG_PJS", "HUMAN CAPITAL AREA HEAD", "HUMAN CAPITAL BUSINESS PARTNER HEAD", "TELE CENTER HEAD", "UM MICRO HEAD", "UNIT HEAD AUDIT MIKRO", "UNIT HEAD COLLECTION", "UNIT HEAD FIELD INVESTIGATION", "UNIT HEAD HO", "UNIT HEAD LITIGASI", "UNIT HEAD MIKRO", "UNIT HEAD OPERASIONAL MICRO FINANCING", "UNIT HEAD OPERATIONAL &AMP; SUPPORT", "UNIT HEAD QUALITY SERVICE", "UNIT HEAD RESEARCH &AMP; DEVELOPMENT", "UNIT MICRO HEAD", "DISTRICT COLLECTION SUPERVISOR", "SUPERVISOR BDD", "SUPERVISOR HUMAN CAPITAL AREA", "SUPERVISOR INTERNAL AUDIT",  "SUPERVISOR OPERASIONAL", "SUPERVISOR RESEARCH &AMP; DEVELOPMENT", "SUPERVISOR TELE CENTER"]);



define('DAFTAR_BULAN', ["JANUARI", "FEBRUARI", "MARET", "APRIL", "MEI", "JUNI", "JULI", "AGUSTUS", "SEPTEMBER", "OKTOBER", "NOVEMBER", "DESEMBER"]);



define('RISK_TYPE', ["IYA", "TIDAK"]);